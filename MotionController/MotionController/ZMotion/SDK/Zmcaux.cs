...
namespace MotionController.ZMotion
{
    ...
    *************************************************************/
        ...
        /// </summary>
        /// <param name="handle">连接句柄</param>
        /// <param name="Max_VirtuAxises">最大虚拟轴数(起码占用1个uint8)</param>
        /// <param name="Max_motor">最大电机数量(起码占用1个uint8)</param>
        /// <param name="Max_io">最大IN,OUT,AD,DA数量,(起码占用4个uint8)</param>
        /// <returns>错误码</returns>
        ...
        /// </summary>
        /// <param name="handle">连接句柄</param>
        /// <param name="pfilename">文件名, 必须是3次文件</param>
        /// <param name="pfilenameinControl">支持NC文件名, 必须带名称, 否则无法区分bas还是NC文件</param>
        /// <param name="ifile3num">选择哪个3次文件缓冲</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Down3FileRam", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Down3FileRam(IntPtr handle, string pfilename, string pfilenameinControl, int ifile3num);
        ...
        /// <param name="iaxis">轴号</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_BusCmd_NodePdoWriteFloat", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_BusCmd_NodePdoWriteFloat(IntPtr handle, UInt32 inode, UInt32 index, UInt32 subindex, UInt32 type, float value);
        ...
        /// <param name="iaxis">轴号</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_BusCmd_NodePdoReadFloat", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_BusCmd_NodePdoReadFloat(IntPtr handle, UInt32 inode, UInt32 index, UInt32 subindex, UInt32 type, ref float ivalue);
        ...
        /// <param name="pTickslist">周期列表</param>
        /// <param name="pfDisancelist">距离列表</param>
        /// <param name="pSpeedlist">速度列表</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_MultiMovePvt", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_MultiMovePvt(IntPtr handle, int iMoveLen, int imaxaxises, int[] piAxislist, UInt32[] pTickslist, float[] pfDisancelist, float[] pSpeedlist);
        ...
        /// <param name="pSpeedlist">速度列表</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_MultiMovePvtAbs", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_MultiMovePvtAbs(IntPtr handle, int iMoveLen, int imaxaxises, int[] piAxislist, UInt32[] pTickslist, float[] pfDisancelist, float[] pSpeedlist);
        ...
        /// <param name="handle">连接句柄</param>
        /// <param name="iaxis">轴号</param>
        /// <param name="fValue">运动的剩余时间</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Execute_GetMoveTime", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Execute_GetMoveTime(IntPtr handle, int iaxis, ref float fValue);

        /// <summary>
        /// 预估点位运动时间, ms单位
        /// VP_MODE=7,  AXIS_MODE BIT6 置位时, 可以返回准确时间.
        /// !注意, 计算使用FORCE_SPEED来计算, 避免为计算修改SPEED影响当前运动.
        /// </summary>
        /// <param name="handle">连接句柄</param>
        /// <param name="dis">轴的运动距离</param>
        /// <param name="fValue">预估点位运动时间</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Execute_GetPreCalTime", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Execute_GetPreCalTime(IntPtr handle, float dis, ref float fValue);
        ...
        /// <param name="handle">连接句柄</param>
        /// <param name="iaxis">轴号</param>
        /// <param name="mode">加减速曲线类型选择</param>
        /// 0 - 缺省值，使用sramp来设置S曲线
        ...
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_SetVpMode", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_SetVpMode(IntPtr handle, int iaxis, int mode);
        ...
        /// <param name="handle">连接句柄</param>
        /// <param name="iaxis">轴号</param>
        /// <param name="mode">模式设置直接填写位数数值即可</param>
        /// 轴参数:
        /// BIT6	  缺省0, 1-使用可以预知准确时间的算法, 目前VP_MODE=7下有效
        /// BIT7  缺省0, 1- MOVEMODIFY 时, 尽可能避免反向运行, 会使用更大的减速度
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_SetAxisMode", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_SetAxisMode(IntPtr handle, int iaxis, int mode);
        ...
        /// <param name="imaxaxises">参与运动总轴数</param>
        /// <param name="piAxislist">轴号列表</param>
        /// <param name="end1">第1个轴运动距离参数1	相对坐标</param>
        /// <param name="end2">第2个轴运动距离参数1	相对坐标</param>
        /// <param name="centre1">第1个轴运动距离参数2	相对坐标</param>
        /// <param name="centre2">第2个轴运动距离参数2	相对坐标</param>
        /// <param name="mode">第2个轴运动距离参数2	相对坐标</param>
        /// mode
        /// 0当前点，中间点，终点三点定圆弧                距离参数1为终点距离，距离参数2为中间点距离
        /// 1当前点，圆心，终点定圆弧  走最短的圆弧,       距离参数1为终点距离，距离参数2为圆心的距离
        /// 2当前点，中间点，终点三点定圆                  距离参数1为终点距离，距离参数2为中间点距离
        /// 3当前点，圆心，终点定圆  先走最短的圆弧，再继续走完整圆,距离参数1为终点距离，距离参数2为圆心的距离
        /// <param name="distance0">第4个轴运动距离参数</param>
        /// <param name="distance1">第5个轴运动距离参数</param>
        /// <param name="distance2">第6个轴运动距离参数</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_Mover_C", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_Mover_C(IntPtr handle, int imaxaxises, int[] piAxislist, float end1, float end2, float centre1, float centre2, int mode, float distance0, float distance1, float distance2);

        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_Mover_CABS", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_Mover_CABS(IntPtr handle, int imaxaxises, int[] piAxislist, float end1, float end2, float centre1, float centre2, int mode, float distance0, float distance1, float distance2);

        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_Mover_C3", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_Mover_C3(IntPtr handle, int imaxaxises, int[] piAxislist, float end1, float end2, float end3, float centre1, float centre2, float centre3, int mode, float distance0, float distance1, float distance2);

        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_Mover_C3ABS", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_Mover_C3ABS(IntPtr handle, int imaxaxises, int[] piAxislist, float end1, float end2, float end3, float centre1, float centre2, float centre3, int mode, float distance0, float distance1, float distance2);
        ...
        /// <param name="pfDisancelist">距离列表</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_Mover_L", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_Mover_L(IntPtr handle, int imaxaxises, int[] piAxislist, float[] pfDisancelist);
        ...
        /// <param name="pfDisancelist">距离列表</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_Mover_LAbs", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_Mover_LAbs(IntPtr handle, int imaxaxises, int[] piAxislist, float[] pfDisancelist);
        ...
        /// <param name="imaxaxises">参与运动总轴数</param>
        /// <param name="piAxislist">轴号列表</param>
        /// <param name="distance0">坐标系B沿X^的平移距离</param>
        /// <param name="distance1">坐标系B沿Y^的平移距离</param>
        /// <param name="distance2">坐标系B沿Z^的平移距离</param>
        /// <param name="Radian0">坐标系B沿X^的旋转的弧度</param>
        /// <param name="Radian1">坐标系B沿Y^的旋转的弧度</param>
        /// <param name="Radian2">坐标系B沿Z^的旋转的弧度</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Frame_Rotate", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Frame_Rotate(IntPtr handle, int imaxaxises, int[] piAxislist, float distance0, float distance1, float distance2, float Radian0, float Radian1, float Radian2);
        ...
        /// <param name="handle">连接句柄</param>
        /// <param name="iaxis">轴号</param>
        /// <param name="wdpos">对应世界坐标系</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_World_DPos", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_World_DPos(IntPtr handle, int iaxis, ref float wdpos);
        ...
        /// <param name="handle">连接句柄</param>
        /// <param name="iaxis">轴号</param>
        /// <param name="piValue">当前姿态</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_FrameStatus", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_FrameStatus(IntPtr handle, int axis, int piValue);
        ...
        /// <param name="piAxislist">轴号列表</param>
        /// <param name="imaxaxises">轴数量</param>
        /// <param name="tablein">table数组中的索引号，从这个索引开始连续存储数据，正解时输入关节坐标，逆解时输入虚拟轴坐标列表，最后附加姿态</param>
        /// <param name="tableout">table这个索引开始存储数据，正解时输出虚拟坐标，最后附加姿态，逆解时输出关节坐标列表</param>
        /// <param name="dirmode">模式类型描述</param>
        /// 0逆解     虚拟轴到关节轴，无姿态，自动使用当前的姿态
        /// 1正解     关节轴到虚拟轴，无姿态输出
        /// 2逆解     输入虚拟轴坐标，最后加上姿态
        /// 3正解     输出虚拟轴坐标，输出最后一个位置填姿态
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_FrameTrans2", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_FrameTrans2(IntPtr handle, int[] piAxislist, int imaxaxises, int tablein, int tableout, int dirmode);

        /// <summary>
        /// 坐标系变换计算
        /// 手动计算坐标系旋转后的坐标值  使用时需控制器当前存在机械链接
        ...
        /// <param name="piAxislist">轴号列表</param>
        /// <param name="imaxaxises">轴数量</param>
        /// <param name="tablein">转换前，填写的坐标存储table位置</param>
        /// <param name="tableout">转换后，输出的坐标存储table位置</param>
        /// <param name="dir">0(DPOS 到WORLD_DPOS;)1(WORLD_DPOS  到 DPOS)</param>
        /// <param name="distance">坐标系B沿X^,Y^,Z^的平移距离</param>
        /// <param name="radian">坐标系B沿X^,Y^,Z^的旋转的弧度</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Frame_Rotate2", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Frame_Rotate2(IntPtr handle, int[] piAxislist, int imaxaxises, int tablein, int tableout, int dir, ref float distance, ref float radian);
        ...
        /// <param name="piAxislist">轴号列表</param>
        /// <param name="imaxaxises">轴数量</param>
        /// <param name="tablein">关节坐标存储的table起始编号，每个点的关节坐标按顺序存储，多个点之间间隔space</param>
        /// <param name="space">每两个点之间间隔的table元素</param>
        /// <param name="groups">点数</param>
        /// <param name="tableaux">辅助参数的table编号，部分frame需要</param>
        /// <param name="zeroout">计算出来理论零点时关节轴的绝对坐标的table编号</param>
        /// <param name="tableout2">计算出来的机械手参数存储的位置，不填时直接存储原参数的位置</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_FrameCal", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_FrameCal(IntPtr handle, int[] piAxislist, int imaxaxises, int tablein, int space, int groups, int tableaux, int zeroout, int tableout2);
        ...
        /// <param name="pstringin">数据的字符串</param>
        /// <param name="inumes">转换数据个数</param>
        /// <param name="pfvlaue">转换的数据</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_TransStringtoDouble", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_TransStringtoDouble(string pstringin, int inumes,  ref double pfvlaue);

        /// <summary>
        /// table,double方式读取, 可以一次读取多个
        /// </summary>
        /// <param name="handle">连接句柄</param>
        /// <param name="tabstart">读取TABLE起始地址</param>
        /// <param name="inumes">读取的数量</param>
        /// <param name="pfvlaue">读取的数据 多个时必须分配空间</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_GetTableDouble", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_GetTableDouble(IntPtr handle, int tabstart, int inumes, double[] pfValue);
        ...
        /// <param name="handle">连接句柄</param>
        /// <param name="tabstart">写入的TABLE起始编号</param>
        /// <param name="inumes">写入的数量</param>
        /// <param name="pfvlaue">写入的数据值</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_SetTableDouble", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_SetTableDouble(IntPtr handle, int tabstart, int numes, double[] pfValue);
        ...
        /// </summary>
        /// <param name="handle">连接句柄</param>
        /// <param name="iEnable">是否使能</param>
        /// <param name="iPeriod">采样周期 以控制器周期为单位</param>
        /// <param name="iStartTab">数据起始TABLE位置</param>
        /// <param name="iStopTab">数据停止TABLE位置</param>
        /// <param name="iParaNum">采集数据源数量 最大8个</param>
        /// <param name="ParaNamep">采集数据源字符名称</param>
        /// <returns>错误码</returns>
/*        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Scope", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Scope(IntPtr handle, int iEnable, int iPeriod, int iStartTab, int iStopTab, int iParaNum, string[] ParaNamep);*/
        ...
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_GetScopeLength", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_GetScopeLength(IntPtr handle, ref int ilen);
        ...
        /// <param name="Mode">模式</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_MoveHwPswitch2", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_MoveHwPswitch2(IntPtr handle, int Axisnum, int Mode, int Opnum, int Opstate, float ModePara1, float ModePara2, float ModePara3, float ModePara4, float HwTimerOpenTime, float HwTimerCycTime, int HwTimerReptimes);
        ...
        /// <param name="uTime">控制延时输出口</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_MoveOpDelay", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_MoveOpDelay(IntPtr handle, float uTime, int nAxis);

        /// <summary>
        /// 打包字符串运动下发
        /// </summary>
        /// <param name="handle">连接句柄</param>
        /// <param name="pbuffer">运动字符串</param>
        /// <param name="buffsize">字符串下载大小</param>
        /// <param name="File3Name">下载生成的3次文件名称</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_DownMem3FileRam", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_DownMem3FileRam(IntPtr handle, string pbuffer, UInt32 buffsize,StringBuilder File3Name, int ifile3num);


        /// <summary>
        /// 硬件位置比较输出2 4系列产品, 20170513以上版本支持
        /// </summary>
        /// <param name="handle">连接句柄</param>
        /// <param name="AxisList">轴列表</param>
        /// <param name="Axisnum">轴数量</param>
        /// <param name="Mode">模式</param>
        /// <param name="Opnum">对应的输出口</param>
        /// <param name="Opstate">第一个比较点的输出状态</param>
        /// <param name="maxerr">比较位置每个轴左右的脉冲偏差, 进入偏差范围后开始比较</param>
        /// <param name="TmodePara1">7模式：（第一个比较点VECTOR_MOVED坐标所在TABLE编号）25，26，35，36模式（TABLE 里面存储的比较点个数.）</param>
        /// <param name="TmodePara2">7模式：（最后一个比较点VECTOR_MOVED坐标所在TABLE编号）25，26，35，36模式（第一个比较点坐标所在 TABLE 编号）</param>
        /// 与 hwtimer 并用时, 可以动态调整 hwtimer 参数
        /// <param name="ModeFlag">是否启用动态调整hwtimer参数</param>
        /// <param name="ModePara1">脉冲时间</param>
        /// <param name="ModePara2">脉冲个数</param>
        /// <param name="ModePara3">脉冲周期</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_HwPswitch2_2", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_HwPswitch2_2(IntPtr handle, int[] AxisList, int Axisnum, int Mode, int Opnum, int Opstate, int maxerr, int TmodePara1, int TmodePara2, bool ModeFlag, float ModePara1, float ModePara2, float ModePara3);


        /// <summary>
        /// MOVE_OP提前一定距离输出设置, 缺省0不生效，设置正数会比缺省输出位置提前指定矢量距离，设置负数则延后指定矢量距离
        /// </summary>
        /// <param name="handle">连接句柄</param>
        /// <param name="iaxis">轴号</param>
        /// <param name="distance">输出口编号</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_MoveOpAdist", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_MoveOpAdist(IntPtr handle, int iaxis, float distance);
        ...
        /// <param name="handle">连接句柄</param>
        /// <param name="iaxis">轴号</param>
        /// <param name="homeIn">原点映射IO编号</param>
        /// <param name="piValue">轴状态返回值</param>
        /// <param name="iIdle">轴状态返回值  0，运动中，其他，无运动</param>
        /// <param name="bHomestaus">轴状态返回值</param>
        /// <param name="BusEnableStaus">总线轴使能状态</param>
        /// <returns>错误码</returns>
        ...
        public static extern Int32 ZAux_Direct_GetAxisStatus2(IntPtr handle, int iaxis, int homeIn, ref int piValue, ref int iIdle, ref int bHomestaus, ref int BusEnableStaus);
        ...
        /// <param name="homestatus">回零完成标志 0-回零异常 1回零成功</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_GetHomeStatus2", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_GetHomeStatus2(IntPtr handle, UInt32 iaxis, ref UInt32 homestatus);
        ...
        /// <param name="handle">连接句柄</param>
        /// <param name="iaxis">轴号</param>
        /// <param name="homestatus">回零完成标志 0-回零未成功 1-回零成功 2-回零运动中</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_BusCmd_GetHomeStatus2", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_BusCmd_GetHomeStatus2(IntPtr handle, UInt32 iaxis, ref UInt32 homestatus);

        /// <summary>
        /// 设置HW_PSWITCH2指令实际操作的轴号，缺省-1表示不修改
        /// </summary>
        /// <param name="handle">连接句柄</param>
        /// <param name="iaxis1">占用的缓冲轴号</param>
        /// <param name="iaxis2">绑定的实际操作的轴号</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_SetHwPs2AxisNum", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_SetHwPs2AxisNum(IntPtr handle, int iaxis1, int iaxis2);

        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_GetHwPs2AxisNum", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_GetHwPs2AxisNum(IntPtr handle, int iaxis1, ref int iaxis2);
        ...
        /// <param name="handle">连接句柄</param>
        /// <param name="iaxis">轴号</param>
        /// <param name="ivalue">实际已经比较的点数</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_GetHwPs2Counts", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_GetHwPs2Counts(IntPtr handle, int iaxis, ref int ivalue);

        /// <summary>
        /// 读取节点SDO参数信息(兼容更新功能)
        /// </summary>
        /// <param name="handle">连接句柄</param>
        /// <param name="slot">槽位号 缺省0</param>
        /// <param name="node">节点编号</param>
        /// <param name="index">对象字典编号（注意函数为10进制数据）</param>
        /// <param name="subindex">子编号（注意函数为10进制数据）</param>
        /// <param name="type">数据类型  1-bool 2-int8 3-int16 4-int32 5-uint8 6-uint16 7-uint32</param>
        /// <param name="Oun_string">返回值内容，以字符串形式输出</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_BusCmd_SDORead2", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_BusCmd_SDORead2(IntPtr handle, UInt32 slot, UInt32 node, UInt32 index, UInt32 subindex, UInt32 type, StringBuilder Out_string, int stringLen);
        ...
        /// <param name="subindex">子编号（注意函数为10进制数据）</param>
        /// <param name="type">数据类型  1-bool 2-int8 3-int16 4-int32 5-uint8 6-uint16 7-uint32</param>
        /// <param name="in_string">设定的数据值(以字符串格式写入)</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_BusCmd_SDOWrite2", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_BusCmd_SDOWrite2(IntPtr handle, UInt32 slot, UInt32 node, UInt32 index, UInt32 subindex, UInt32 type, StringBuilder in_string);
        ...
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Up3File", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Up3File(IntPtr handle, string pfilename, string pfilenameinControl);

        /// <summary>
        /// 上传3次
        /// </summary>
        /// <param name="handle">连接句柄</param>
        /// <param name="pbuffer">内存buff</param>
        /// <param name="buffsize">返回实际的文件长度</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Up3FileToMem", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Up3FileToMem(IntPtr handle, StringBuilder pbuffer, UInt32 buffsize, string pfilenameinControl, ref UInt32 puifilesize);

        /// <summary>
        /// 读取轴是否运动结束（引入编码器速度判断，当idle=-1且mspeed为0时，返回停止）
        /// </summary>
        /// <param name="handle">连接句柄</param>
        /// <param name="iaxis">轴号</param>
        /// <param name="piValue">返回运行状态 0-运动中 -1 停止</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_GetIfIdle2", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_GetIfIdle2(IntPtr handle, int iaxis, ref int piValue);

        /// <summary>
        /// 设置VRINT
        /// </summary>
        /// <param name="handle">连接句柄</param>
        /// <param name="vrnum">Vr_INT编号</param>
        /// <param name="piValue">设置的值</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_SetVrInt", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_SetVrInt(IntPtr handle, int vrnum, int piValue);

        /// <summary>
        /// 设置tablestring
        /// </summary>
        /// <param name="handle">连接句柄</param>
        /// <param name="start">table起始地址</param>
        /// <param name="inum">长度</param>
        /// <param name="pidata">写入的字符串</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Execute_SetTableString", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Execute_SetTableString(IntPtr handle, int start, int inum, StringBuilder pidata);

        /// <summary>
        /// 设置vrstring
        /// </summary>
        /// <param name="handle">连接句柄</param>
        /// <param name="start">Vr起始地址</param>
        /// <param name="inum">长度</param>
        /// <param name="pidata">写入的字符串</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Execute_SetVrString", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Execute_SetVrString(IntPtr handle, int start, int inum, StringBuilder pidata);
        ...
        /// <param name="start">Vr起始地址</param>
        /// <param name="inum">长度</param>
        /// <param name="pidata">获取的字符串</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Execute_GetTableString", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Execute_GetTableString(IntPtr handle, int start, int inum, StringBuilder pidata);
        ...
        /// <param name="pidata">获取的字符串</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Execute_GetVrString", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Execute_GetVrString(IntPtr handle, int start, int inum, StringBuilder pidata);

        /// <summary>
        /// 读取在线命令的应答， 对没有接收应答的命令有用  此函数不阻赛
        /// </summary>
        /// <param name="handle">连接句柄</param>
        /// <param name="pbuff">返回读取结果</param>
        /// <param name="uimax">缓冲长度</param>
        /// <param name="puiread">读取的长度</param>
        /// <param name="pbifExcuteDown">是否已经执行结束</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_ExecuteGetReceive", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_ExecuteGetReceive(IntPtr handle, StringBuilder pbuff, UInt32 uimax, ref UInt32 puiread ,ref byte pbifExcuteDown);
        ...
        /// <param name="puiread">读取的长度</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_ReadMessage", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_ReadMessage(IntPtr handle, byte[] pbuff, UInt32 uimax, ref UInt32 puiread);

        /// <summary>
        /// RT 消息操作
        /// </summary>
        /// <param name="isel">预留</param>
        /// <param name="icode"> 1- 启动RT,  2- 停止RT</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_LocalRTManage", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern UInt32 ZAux_LocalRTManage(Int32 isel, Int32 icode);

        [DllImport("zauxdll.dll", EntryPoint = "ZAux_GetLocalRTState", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern UInt32 ZAux_GetLocalRTState(Int32 isel);

        /// <summary>
        /// 下载3次文件到ROM
        /// </summary>
        /// <param name="pfilename">3次文件名称</param>
        /// <param name="pfilenameinControl">支持NC文件名, 必须带名称, 否则无法区分bas还是NC文件</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Down3FileRom", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Down3FileRom(IntPtr handle, string pfilename, string pfilenameinControl);

        /// <summary>
        /// 获取控制器flash中的3次文件的个数，只能获取到nc文件和z3p文件
        /// </summary>
        /// <param name="handle">连接句柄</param>
        /// <param name="pFileCnt">输出控制器的3次文件的个数</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_GetRomAll3FileCnt", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_GetRomAll3FileCnt(IntPtr handle, ref UInt32 pFileCnt);

        /// <summary>
        /// 获取控制器flash中的3次文件，只能获取到nc文件和z3p文件
        /// </summary>
        /// <param name="handle">连接句柄</param>
        /// <param name="pfileNameList">3次文件名称</param>
        /// <param name="pFileSize">输出的3次文件的字节大小数组，输出每个文件的大小</param>
        ///                         需要先提前获取文件个数，在创建此个数大小的数组传入
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_GetRomAll3File", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_GetRomAll3File(IntPtr handle, StringBuilder pfileNameList, UInt32[] pFileSize);
        ...
        /// <param name="handle">连接句柄</param>
        /// <param name="iaxis">轴号</param>
        /// <param name="piValue">设置的模式</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_GetVpMode", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_GetVpMode(IntPtr handle, int iaxis, ref int piValue);
        ...
        /// <param name="handle">连接句柄</param>
        /// <param name="iaxis">轴号</param>
        /// <param name="dValue">设置的值</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_SetJerk", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_SetJerk(IntPtr handle, int iaxis, double dValue);
        ...
        /// <param name="handle">连接句柄</param>
        /// <param name="iaxis">轴号</param>
        /// <param name="pdValue">获取的值</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_GetJerk", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_GetJerk(IntPtr handle, int iaxis, ref double pdValue);
        ...
        /// <param name="handle">连接句柄</param>
        /// <param name="iaxis">轴号</param>
        /// <param name="fValue">设置的值</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_SetCornerAccel", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_SetCornerAccel(IntPtr handle, int iaxis, float fValue);
        ...
        /// <param name="handle">连接句柄</param>
        /// <param name="iaxis">轴号</param>
        /// <param name="pfValue">获取的值</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_GetCornerAccel", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_GetCornerAccel(IntPtr handle, int iaxis, ref float pfValue);

        /// <summary>
        /// 设置zsmooth_mode 连续多段平滑模式
        /// </summary>
        /// <param name="handle">连接句柄</param>
        /// <param name="iaxis">轴号</param>
        /// <param name="iValue">设置的值</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_SetZsmoothMode", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_SetZsmoothMode(IntPtr handle, int iaxis, int iValue);

        /// <summary>
        /// 获取zsmooth_mode 连续多段平滑模式
        /// </summary>
        /// <param name="handle">连接句柄</param>
        /// <param name="iaxis">轴号</param>
        /// <param name="iValue">获取的值</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_GetZsmoothMode", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_GetZsmoothMode(IntPtr handle, int iaxis, ref int piValue);

        /// <summary>
        /// 二维螺距补偿, 4系列(VERSION_BUILD > 230511)特殊固件支持.  比较占CPU, 标准固件不支持.
        /// </summary>
        /// <param name="handle">连接句柄</param>
        /// <param name="iaxisList">轴号列表</param>
        /// <param name="iEnable">0- 关闭补偿,  1- XY补偿</param>
        /// <param name="StartPosX">起始补偿MPOS位置X,</param>
        /// <param name="StartPosY">起始补偿MPOS位置Y,</param>
        /// <param name="DisOneX">每个补偿点间距X,</param>
        /// <param name="DisOneY">每个补偿点间距Y,</param>
        /// <param name="maxpointX">补偿区间总点数</param>
        /// <param name="maxpointy">补偿区间总点数</param>
        /// <param name="Tableindex">螺距补偿表存储的table位置，从startpos下一个点开始存储，脉冲数单位, 每个点存储两个数据,表示X方向偏差值与Y方向偏差值. 先存储第一行(X方向), 再存储第二行.总共占用 maxpointx*maxpointy*2 个TABLE位置.</param>
        /// <param name="pfDisancelist">区间补偿值列表</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_Pitch2set", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_Pitch2set(IntPtr handle, int[] iaxisList, int iEnable, float StartPosX, float StartPosY, float DisOneX, float DisOneY, UInt32 maxpointX, UInt32 maxpointY, UInt32 Tableindex, float[] pfDisancelist);
        ...
        /// <param name="fset">设定值</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_SetVectorMoved", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_SetVectorMoved(IntPtr handle, int iaxis, float fset);
        ...
        /// <param name="handle">连接句柄</param>
        /// <param name="iaxis">轴号</param>
        /// <param name="pfValue">读取的返回值</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_GetVectorMoved", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_GetVectorMoved(IntPtr handle, int iaxis, ref float pfValue);
        ...
        /// <param name="pfValue">设定值</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_SetVectorBuffered2", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_SetVectorBuffered2(IntPtr handle, int iaxis, float pfValue);
        ...
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_SetVectorBuffered2", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_GetVectorBuffered2(IntPtr handle, int iaxis, ref float pfValue);

        /// <summary>
        /// 硬件定时器用于硬件比较输出后一段时间后还原电平 4系列产品支持
        /// </summary>
        /// <param name="handle">连接句柄</param>
        /// <param name="mode">0停止, 1-动态修改参数（不修改启动设置）， 2-启动，
	///						3-停止硬件定时器（类似0，针对振镜控制器），当前脉冲完成后不再输出，但后面的OP仍会继续触发脉冲 
	///						4-脉冲duty变化功能，配合模式1/2使用。(ZMC420SCAN 221017增加mode4)</param>
        /// <param name="cyclonetime">mode=1,2:	周期时间    us单位				mode=4:剩余多少个脉冲数时开始调整脉冲的宽度，注意第一个脉冲不变化，0-表示不使用</param>
        /// <param name="optime">mode=1,2:	有效时间    us单位				mode=4:剩余多少个脉冲数时开始调整脉冲的宽度，注意第一个脉冲不变化，0-表示不使用</param>
        /// <param name="reptimes">mode=1,2:	重复次数					mode=4:变化脉冲个数</param>
        /// <param name="opstate">mode=1,2:	输出缺省状态	输出口变为非此状态后开始计时       mode=4:预留，设为0即可</param>
        /// <param name="opnum">mode=1,2,4:	输出口编号	必须能硬件比较输出的口</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_MoveHwTimer", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_MoveHwTimer(IntPtr handle, int mode,int cyclonetime,int optime,int reptimes,int opstate,int opnum);
        ...
        /// <param name="handle">连接句柄</param>
        /// <param name="Axisnum">轴号</param>
        /// <param name="Mode">//模式	 mode=1	 每个比较点触发都会使得当前输出口电平翻转。
	...
	///						Para4：预留</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_MoveHwPswitch", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_MoveHwPswitch(IntPtr handle, int Axisnum,int Mode, float Para1, float Para2, float Para3, float  Para4);
        ...
        /// <param name="handle">连接句柄</param>
        /// <param name="Axisnum">轴号</param>
        /// <param name="Mode">//模式	 mode=2  停止并删除没完成的比较点.
	///						Para1：预留
	///						Para2：预留
	///						Para3：预留
	///						Para4：预留
	...
	///						Para4：预留</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Direct_HwPswitchVector", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_Direct_HwPswitchVector(IntPtr handle, int Axisnum,int Mode, float Para1, float Para2, float Para3, float  Para4);
        ...
        /// <param name="index">对象字典编号（注意函数为10进制数据）</param>
        /// <param name="subindex">子编号（注意函数为10进制数据）</param>
        /// <param name="type">数据类型  1-bool 2-int8 3-int16 4-int32 5-uint8 6-uint16 7-uint32,8-FLOAT,9-STRING</param>
        /// <param name="Oun_string">返回值内容，以字符串形式输出</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_BusCmd_NodePdoRead2", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_BusCmd_NodePdoRead2(IntPtr handle, UInt32 slot, UInt32 node, UInt32 index, UInt32 subindex, UInt32 type, StringBuilder Out_string, int stringLen);
        ...
        /// <param name="in_string">设定的数据值(以字符串格式写入)</param>
        /// <returns>错误码</returns>
        [DllImport("zauxdll.dll", EntryPoint = "ZAux_BusCmd_NodePdoWrite2", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern Int32 ZAux_BusCmd_NodePdoWrite2(IntPtr handle, UInt32 slot, UInt32 node, UInt32 index, UInt32 subindex, UInt32 type, StringBuilder in_string);
    }
}
